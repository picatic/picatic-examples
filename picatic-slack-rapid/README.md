...
## Share Picatic event and allow ticket registration within Slack.

This project utilizes [Rapid API](https://rapidapi.com) and [Picatic API](http://developer.picatic.com/). Here is an example use case.
