        ...
        <section className="max-width-3 mx-auto mt4">
          ...
          >
            <CardContent style={{ margin: '0px 24px', padding: '32px 0px' }}>
              <div className="flex items-center justify-center mb2 center">
                <div className="mr2">{picaticLogo}</div>
                <Text variant="body3" color="extraMuted">
                  +
                </Text>
                <div className="ml2">{airbnbLogo}</div>
              </div>
    ...
    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      <g transform="translate(-46.000000, -47.000000)" fill="#3F51B5">
        <g id="create-/-user-menu" transform="translate(40.000000, 40.000000)">
          <g id="picatic-logo">
            <g id="logo" transform="translate(6.000000, 5.000000)">
              <g id="Group" transform="translate(0.000000, 1.948363)">
                <polyline
                  id="Shape"
                  points="21.120626 0.128313595 29.7771149 0.128313595 23.1986222 16.8460998 14.5421333 16.8460998 21.120626 0.128313595"
                />
                <polyline
                  id="Path"
                  points="10.0120139 0.128313595 18.6685028 0.128313595 8.79418082 25.17869 0.137691934 25.17869 10.0120139 0.128313595"
                />
              </g>
            </g>
          </g>
